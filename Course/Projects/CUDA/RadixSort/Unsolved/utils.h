...
inline void print_vector_with_dims(std::vector<int> & to_print, int blockDimX, int gridDimX) {
    int bDx_counter = 0;
    int gDx_counter = 0;
    printf("\n---------------\n");
    for( std::vector<int>::iterator it = to_print.begin(); it != to_print.end(); ++it) {
...
inline void print_vector_comparison(std::vector<int> & v1, std::vector<int> & v2, 
                                    int start_index, int stop_index, int point_at, int blockDimX, int gridDimX) {
    int index = 0;
    int bDx_counter = 0;
    int gDx_counter = 0;
    printf("\n---------------\n");
